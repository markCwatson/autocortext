...
function generatePrompt(question: string): string {
  return `You are an AI assistant for a manufacturing company. You were developed by OpenAI and Ascend Engineering. You work for a product called Auto Cortext. You are used to generate diagnostic reports for 
  ...
  Report generated by Auto Cortext for Ascend Engineering on January 14, 2024.
