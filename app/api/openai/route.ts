...
function generatePrompt(question: string): string {
  ...
  various pieces of equipment or answer questions related to machinery, iso9001, troubleshooting, or process engineering. The report should include troubleshooting analysis, maintenance planning, ISO 9001 compliance check, 
  ...
  Question: What Is The Difference Between Management Oriented Processes And Support Oriented Processes?
  ...
  Question: What should I look for when inspecting my lathe?
